...
public class RecordFieldGetter {
   ...
   */
  public static FieldGetter createFieldGetter(
      DataType dataType, String fieldName, boolean isNullable) {
    ...
    switch (dataType.getFieldType()) {
      ...
      case ENUM:
        fieldGetter =
            record ->
                DataTypeUtils.toEnum(
                    record.getValue(fieldName), (EnumDataType) dataType, fieldName);
        break;
      case ARRAY:
        fieldGetter =
            record ->
      ...
      case RECORD:
        fieldGetter =
            record -> record.getAsRecord(fieldName, ((RecordDataType) dataType).getChildSchema());
        break;
      case CHOICE:
        fieldGetter =
            record -> {
              ...
              return DataTypeUtils.convertType(
                  record.getValue(fieldName), chosenDataType, fieldName);
            };
        break;
      default:
